...
const account1 = {
  ...
  movementsDates: [
    ...
    '2019-07-19T07:42:02.383Z',
    '2020-07-20T09:15:04.904Z',
    '2020-07-22T10:17:24.185Z',
    '2020-07-24T14:11:59.604Z',
...
setTimeout(function () {
  return console.log(`Here is yoyr pizaa`);
}, 3000);
...
//     second: 'numeric',
//   };
//   labelBalance.textContent = new Intl.DateTimeFormat('en-US', optionss).format(
//     noww
//   );
// }, 1000);
